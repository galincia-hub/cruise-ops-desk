...
.ops-table{width:100%;border-collapse:collapse;background:var(--bg-primary);font-size:13px;transition:background var(--transition);empty-cells:show}
.ops-table td,.ops-table th{background:inherit}
.ops-table td:empty{background:inherit}
...
.ops-table tbody tr{background:var(--bg-primary);min-height:40px}
.ops-table tbody tr:nth-child(even){background:var(--bg-secondary)}
.ops-table tbody tr[style*="--row-bg"]{background:color-mix(in srgb,var(--row-bg) 35%,var(--bg-primary))}
